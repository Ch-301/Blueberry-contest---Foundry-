...
import  "../libraries/UniV3/UniV3WrappedLib.sol";
    ...
    Ownable
{
    ...
    function rebalance(
        ...
        if (swapQuantity != 0) {
            IUniswapV3Pool(pool).swap(
                ...
                swapQuantity > 0
                    ? UniV3WrappedLib.MIN_SQRT_RATIO + 1
                    : UniV3WrappedLib.MAX_SQRT_RATIO - 1,
    ...
    function _amountsForLiquidity(
        ...
        return
            UniV3WrappedLib.getAmountsForLiquidity(
                sqrtRatioX96,
                UniV3WrappedLib.getSqrtRatioAtTick(tickLower),
                UniV3WrappedLib.getSqrtRatioAtTick(tickUpper),
                liquidity
            );
    }
    ...
    function _liquidityForAmounts(
        ...
        (uint160 sqrtRatioX96, , , , , , ) = IUniswapV3Pool(pool).slot0();
        return
            UniV3WrappedLib.getLiquidityForAmounts(
                sqrtRatioX96,
                UniV3WrappedLib.getSqrtRatioAtTick(tickLower),
                UniV3WrappedLib.getSqrtRatioAtTick(tickUpper),
                amount0,
    ...
    function _fetchTwap(
        ...
        (int256 twapTick, ) = UniV3WrappedLib.consult(_pool, _twapPeriod);
        return
            UniV3WrappedLib.getQuoteAtTick(
